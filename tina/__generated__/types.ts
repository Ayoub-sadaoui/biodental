...
export type Global_Settings = Node & Document & {
  ...
  booking_button_label?: Maybe<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  _sys: SystemInfo;
  _values: Scalars['JSON']['output'];
};
...
export type Global_SettingsFilter = {
  ...
  booking_url?: InputMaybe<StringFilter>;
  booking_button_label?: InputMaybe<StringFilter>;
};
...
export type Global_SettingsMutation = {
  ...
  booking_url?: InputMaybe<Scalars['String']['input']>;
  booking_button_label?: InputMaybe<Scalars['String']['input']>;
};
